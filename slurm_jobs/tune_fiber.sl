#!/bin/bash
#SBATCH --job-name=fiber_tune2           # Job name
...
#SBATCH --gres=gpu:a100:1               # 1x A100 (needed for tune internal inference)
#SBATCH --exclude=g008
#SBATCH --mem=64G
...
echo "==================================="
echo "Optuna parameter sweep (100 trials) - corrected code"
echo "Started: $(date)"
echo "==================================="
